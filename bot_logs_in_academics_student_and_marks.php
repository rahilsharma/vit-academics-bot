<html>
<body>
<form action="academics_parent_login.php" method="post">
...
$LOGINURL = "https://academics.vit.ac.in/student/stud_login.asp";
...
$POSTFIELDS ="message=&regno=".$regno."&passwd=".$passwd."&vrfcd=".$x;                 //kisi ko dene se pehle change kar liyo
...
//getting marks
$reffer ="https://academics.vit.ac.in/student/stud_menu.asp";            //**** headers kafi kaam ka hai aur ****bug bhi dhang se use karna sikh
$LOGINURL = "https://academics.vit.ac.in/student/marks.asp";             //web-******ing mein bhi kaam aa javega
$ch = curl_init();
curl_setopt($ch, CURLOPT_URL,$LOGINURL);
curl_setopt($ch, CURLOPT_USERAGENT, $agent);
curl_setopt($ch, CURLOPT_RETURNTRANSFER, 1);
...
$date=date("d-M-Y");
echo $date;
$reffer="https://academics.vit.ac.in/student/attn_report.asp";
$POSTFIELDS ="from_date=01-Apr-2011&to_date=".$date."&submit=View+Report";
$LOGINURL ="https://academics.vit.ac.in/student/attn_report_submit.asp";
$ch = curl_init();
curl_setopt($ch, CURLOPT_URL,$LOGINURL);
curl_setopt($ch, CURLOPT_USERAGENT, $agent);
curl_setopt($ch, CURLOPT_POST, 1);
